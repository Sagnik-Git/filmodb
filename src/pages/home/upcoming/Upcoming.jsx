...
//console.log("Date after 7 days:" dateNxtWkString);
//console.log("Date after 30 days:", dateNxtMnthString);
...
const Upcoming = () => {
    ...
    const { data, loading } = 
    useFetch(`/movie/upcoming?primary_release_date.gte=${currentDate}&primary_release_date.lte=${endpoint}`);

    const onTabChange = (tab) => {
        setEndpoint(tab === Week ? dateNxtWkString : dateNxtMnthString);
    };
